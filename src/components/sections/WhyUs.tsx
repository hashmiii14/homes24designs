...
const values = [
  ...
  },
  {
    ...
    desc: 'Our senior design directors and project managers conduct rigorous site visits to audit civil masonry, electrical routing, and carpentry alignment — from layout to handover.',
  },
  {
    icon: Home,
