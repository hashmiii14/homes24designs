...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[560px] sm:min-h-[720px] md:min-h-[85vh] lg:min-h-[88vh] max-h-[920px] flex flex-col justify-start sm:justify-end overflow-hidden pt-[5.25rem] sm:pt-28 md:pt-32">
      {/* Background image */}
