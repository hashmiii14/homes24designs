...
export default function ServicesPage() {
  return (
    <>
      <SEO
        title="Interior Design Services in Delhi NCR | HOMES24DESIGNS"
        description="Full home interiors, modular kitchens, living rooms, bedrooms, wardrobes, false ceiling, lighting, wall design and custom turnkey solutions across New Delhi & Delhi NCR."
        path="/services"
        jsonLd={{
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-6">
                ...
                <h2 className="text-section font-light text-charcoal-800 mb-4">
                  Serving New Delhi &amp; Delhi NCR
                </h2>
                <p className="text-sm sm:text-base leading-relaxed text-stone-600 mb-4">
                  Our interior design and turnkey execution services are available across OKHLA, South East Delhi, Jasola, New Friends Colony, Saket, Greater Kailash, New Delhi, Noida, Gurgaon, and the wider Delhi NCR region.
                </p>
